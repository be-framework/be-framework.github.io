...
Be Frameworkは時間とドメインは不可分と考えます。詳細は[変容](./05-metamorphosis-patterns.html)をご覧ください。
...
（詳細：[実装指針](./05-metamorphosis-patterns.html)）
...
* **[変容](./05-metamorphosis-patterns.html)**: 時間とドメインの不可分性
